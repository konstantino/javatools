...
by a javatools.database. The javatools.database can be e.g. an OracleDatabase or a MySQLDatabase.
Before creating instances of this class, you have to build the
javatools.database by the construct-method. This method requires the Prolog-version of WordNet,
which can be downloaded from the WordNet-website.<BR>
Example:
<PRE>
  // Execute this only once to create the javatools.database!
  Database javatools.database=new OracleDatabase("scott","tiger");
  DBWordNet.construct(javatools.database, new File("wordnet/prologversion"));
  
  // Use this code to access the data
  Database javatools.database=new OracleDatabase("scott","tiger");
  DBWordNet wordnet = new DBWordNet(javatools.database);
...
public class DBWordNet {
  ...
  public enum Table {    
    ...
    /** Loads this table to a given javatools.database from a folder with the Prolog version of WordNet */
  ...
  /** Holds the javatools.database */
  protected Database database;
  
  /** Constructs a new DBWordNet, basing on a filled javatools.database*/
  public DBWordNet(Database db) {
    database=db;
  }
  
  /** Fills the javatools.database with WordNet data */
  ...
  /** Returns the javatools.database */
