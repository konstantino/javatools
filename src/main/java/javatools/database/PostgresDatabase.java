...
This class also provides SQL javatools.datatypes (extensions of SQLType.java) that
...
public class PostgresDatabase extends Database {
  ...
  public void connect () throws SQLException{
    ...
    setSchema(schema);
    description = "Postgres javatools.database '" + database + "' as '" + user + "' at " + host + ":" + port + " using schema '" + schema+"'";
  }
...
public static Postgretext postgretext=new Postgretext();
  ...
  /** returns the javatools.database system specific expression for ifnull functionality
  ...
  public static void main(String[] args) {
    try {
      ...
      //d.executeUpdate("CREATE table javatools.test (a integer, b varchar)");
      d.executeUpdate("INSERT into javatools.test values (1,2)");
      ResultSet s = d.query("select * from javatools.test");
      s.next();
      D.p(s.getString(1));
    } catch (Exception e) {
      e.printStackTrace();
