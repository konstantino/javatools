...
Example:
<PRE>
     Database d=new MySQLDatabase("user","password","javatools.database");
...
public class MySQLDatabase extends Database {
  ...
  /** all the information needed to establish a connection to the javatools.database server */
  ...
  public void connect () throws SQLException{
    ...
    description="MySQL javatools.database for "+user+" at "+host+":"+port+", javatools.database "+database;
  }
...
/** BLOB/TEXT type for MySQL */
  ...
  /** a VARCHAR BINARY type, making sure we are case-sensitive in varchar fields 
	 ...
	 *   representation by this one, so if the javatools.database collation is not case-sensitive
