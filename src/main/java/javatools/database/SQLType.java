...
This abstract class provides a Wrapper for SQL javatools.datatypes. A datatype has a type code
...
the same SQL datatype is different for different javatools.database systems, so that different
...
See <A HREF=http://troels.arvin.dk/db/rdbms/>here</A> for a comparison of javatools.database systems.
