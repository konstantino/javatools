...
the YAGO-NAGA team (see http://mpii.de/yago-naga).
  ...
  for javatools.database insertion; note that there is also a version
  of that functionality that makes sure the array strings 
  are all formated for javatools.database insertion/queries (e.g. put in
  quotations).
...
public abstract class StringModifier {
  ...
  /* Concatenates the Strings contained in a collection to a combined string, 
   * separating each two array Strings with the given delimeter 
   * while applying the javatools.database.format function on each array string piece */
   ...
   * separating each two array Strings with the given delimeter 
   * while applying the javatools.database.format function to each array string piece */
   ...
   * while applying the javatools.database.format function to each array entry */
   ...
   * representing the pairs as independent column conditions for a javatools.database query,
   * applying the javatools.database.format function to each value
   ...
   * while optionally applying the javatools.database.format function to each key/value
   * @param map the Map to be imploded
   ...
   * @param database  the Database instance for which the pairs shall be formatted 
   * @param formatKey flag indicating whether to format the keys with javatools.database.format
   * @param formatValue flag indicating whether to format the values with javatools.database.format */
