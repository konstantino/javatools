 ...
 * (e.g. there might be different javatools.database settings etc.).
 *   
 *  
...
public class Parameters {
  ...
  public static File getOrRequestAndAddFile(String s, String description)
	...
	/** Returns the javatools.database defined in this ini-file */
	public static Database getDatabase() throws Exception {
		Parameters
				.ensureParameters(
						"databaseSystem - either Oracle, Postgres or MySQL",
						"databaseUser - the user name for the javatools.database (also: databaseDatabase, databaseInst,databasePort,databaseHost,databaseSchema)",
						"databasePassword - the password for the javatools.database");
		...
		// Initialize the javatools.database
		// ------ ORACLE ----------
		...
		throw new RuntimeException("Unsupported javatools.database system " + system);
	}
